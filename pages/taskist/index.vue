    ...
    <div class="container">
      ...
      >
        ...
        <div class="d-flex align-items-center ms-auto">
          <button
            class="btn btn-outline-primary py-1 px-3 me-3"
            @click="shuffle"
          >
            Shuffle!
          </button>
          ...
          <div class="dropdown">
            <button
              class="btn btn-light dropdown-toggle py-1 px-2 ms-3"
              type="button"
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
              {{ sortedBy ? (sortedBy == "asc" ? "A-Z" : "Z-A") : "Sort by" }}
            </button>
            <ul class="dropdown-menu">
              <li>
                <a
                  class="dropdown-item"
                  href="#"
                  @click="[(sortedBy = 'asc'), orderByTitle('asc')]"
                  >A-Z</a
                >
              </li>
              <li>
                <a
                  class="dropdown-item"
                  href="#"
                  @click="[(sortedBy = 'desc'), orderByTitle('desc')]"
                  >Z-A</a
                >
              </li>
            </ul>
...
export default {
  ...
  methods: {
    ...
    appendTask() {
      ...
      const lastId = this.tasks.sort((a, b) => b.id - a.id)[0].id;
      const id = lastId + 1;
    ...
    orderByTitle(order) {
      ...
      tasks = _.orderBy(tasks, "title", order);
